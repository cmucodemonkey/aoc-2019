...
namespace Day3.Part2
{
    class Program
    {
        ...
        private static List<Point> ParseWirePath(string path)
        {
            ...
            foreach (string instruction in path.Split(','))
            {
                ...
                int length = Convert.ToInt32(instruction.Substring(1, instruction.Length - 1));
