            ...
            while (index < memory.Length && !halt)
            {
                ...
                switch (operationCode)
                {
                    ...
                    case "02":
                        ...
                        break;
                    case "03":
                        saveIndex = memory[index + 1];
                        Console.WriteLine("Input a number:");
                        memory[saveIndex] = Convert.ToInt32(Console.ReadLine());
                        index += 2;
                        break;
                    case "04":
                        saveIndex = memory[index + 1];
                        Console.WriteLine(memory[saveIndex]);
                        index += 2;
                        break;
                    case "05":
                        firstOperand = parameter1Mode == '1' ? memory[index + 1] : memory[memory[index + 1]];
                        secondOperand = parameter2Mode == '1' ? memory[index + 2] : memory[memory[index + 2]];
                        index = firstOperand != 0 ? secondOperand : index + 3;
                        break;
                    case "06":
                        firstOperand = parameter1Mode == '1' ? memory[index + 1] : memory[memory[index + 1]];
                        secondOperand = parameter2Mode == '1' ? memory[index + 2] : memory[memory[index + 2]];
                    ...
                    case "07":
                        ...
                        secondOperand = parameter2Mode == '1' ? memory[index + 2] : memory[memory[index + 2]];
                        saveIndex = memory[index + 3];
                        memory[saveIndex] = firstOperand < secondOperand ? 1 : 0;
                        index += 4;
                        break;
                    case "08":
                        firstOperand = parameter1Mode == '1' ? memory[index + 1] : memory[memory[index + 1]];
